...
const FounderSection = () => {
  return (
    <div className="bg-gray-50 dark:bg-black/70 py-20 rounded-2xl  mb-32 md:mb-64 bg-backdrop-[8px] ">
        ...
        <div className="grid ">
          <div className=" text-center">
            ...
            <div className="flex justify-center space-x-4 text-gray-500">
              {/* facebook */}
              <Link href="/aboutus" target="_blank" aria-label="facebook">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-6 hover:fill-blue-400  fill-white  transition hover:ease-in-out duration-300 "
                  fill="currentColor"
                  viewBox="0 0 16 16"
                >
              ...
              {/* instagram */}
              <Link href="/aboutus" target="_blank" aria-label="instagram">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-6 hover:fill-blue-400  fill-white  transition hover:ease-in-out duration-300 "
                  fill="currentColor"
