  ...
  return (
    <div className="section  bg-gray-600 rounded-xl  flex flex-col justify-center gap-10  px-16 py-24">
      ...
      <div className="font-bold text-4xl  text-black text-white">
        ...
        relationships with your audience. We work closely with our clients to
        understand their business goals and objectives, as well as their target
        audience, to create a customized digital marketing strategy that meets
