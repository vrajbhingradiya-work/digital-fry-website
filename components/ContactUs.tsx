  ...
  return (
    <div className=" section bg-black  rounded-xl overflow-hidden  w-full md:mb-16    relative">
      ...
      <div className="h-full flex  justify-center items-end w-full absolute top-0 ">
        <div className="pb-12 md:pb-0 bg-gradient-to-t from-black via-black/80 to-transparent w-full md:p-6 flex md:flex-row flex-col items-center gap-6 md:gap-32 justify-center md:justify-between absolute ">
          <Reveal sequence={4}>
