...
export default function AboutUs() {
  return (
    <>
      <section className="overflow-hidden pt-32 lg:pt-16 lg:pb-16 bg-white ">
        <div className="container  flex flex-col gap-8 ">
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 w-full lg:py-16">
